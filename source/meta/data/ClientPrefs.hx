...
class ClientPrefs {
	...
	public static var highBitrate:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.mechanicExplanations = mechanicExplanations;
		FlxG.save.data.easyMechanics = easyMechanics;
		...
		FlxG.save.data.highBitrate = highBitrate;
	...
	public static function loadPrefs() {
		...
		if (FlxG.save.data.shaders != null) FlxG.save.data.shaders = shaders;

		if (FlxG.save.data.mechanicExplanations != null) mechanicExplanations = FlxG.save.data.mechanicExplanations;
		if (FlxG.save.data.easyMechanics != null) easyMechanics = FlxG.save.data.easyMechanics;

		if (FlxG.save.data.subtitles != null) subtitles = FlxG.save.data.subtitles;
		...
		if(FlxG.save.data.highBitrate != null) {
			highBitrate = FlxG.save.data.highBitrate;
		}
